...
<ol class="comments_list">
	...
	<li class="comment_wrap" <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
		...
		<p class="comment_meta"> 
			<!-- <?php echo get_avatar( $id_or_email, $size = '48', $default = '' ); ?> -->

			<span class="comment_author">
				<?php comment_author_link() ?>
			</span>

			<span class="comment_time"><?php comment_date('F jS, Y') ?>	<?php comment_time() ?>
			</span>
